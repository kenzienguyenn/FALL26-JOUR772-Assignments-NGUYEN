...
**A1: Computer, Math, and Natural Sciences has the highest mean of seats (440); and one that surprised me the most is University Courses because as someone unfamiliar with the UMD course system, I don't know what this department covers specifically.**
...
**A3: Keith Yearwood who has taught 79 classes**
...
**A4: Given the results from Q3, I think what would have made it easier is if I could filter out the "NA" values in order to see the specific name of the instructor first.**
...
**A5: "**How many courses only have 1 section?"; 48743 classes have only 1 section
